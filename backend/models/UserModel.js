...
const UserModel = {
  ...
  async create({ username, password, role = 'user', email }) {
    ...
    return { id: newUser.$.id, username, role, email };
  },
  ...
  async validatePassword(username, password) {
    ...
    return match ? { id: user.$.id, username: user.username[0], role: user.role[0] } : null;
  },
